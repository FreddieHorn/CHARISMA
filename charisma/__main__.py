...
if __name__ == "__main__":
    ...
    client = OpenAI(
        base_url="https://openrouter.ai/api/v1", api_key=OPEN_ROUTER_API_KEY, max_retries=8
    )
    ...
    # run_pipeline(client)
    print(f"Using model: {config.pipeline.model} from provider: {config.pipeline.provider}")
